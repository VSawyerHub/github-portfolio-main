      ...
      <div className="py-8 grid grid-cols-1 md:grid-cols-2 gap-5">
        <>
          <GlowCard identifier="streak">
            <Image
              src={`https://github-readme-streak-stats.herokuapp.com/?user=${userData.githubUser}&theme=neon&hide_border=true`}
              width={1080}
              height={520}
              alt="github streak"
          ...
          <GlowCard identifier="productive-time">
            <Image
              src={`http://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=${userData.githubUser}&theme=midnight_purple&utcOffset=${userData.timezone}`}
              width={1080}
              height={560}
