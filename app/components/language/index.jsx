      ...
      <div className="py-8 grid grid-cols-1 md:grid-cols-2 gap-5">
        <>
          <GlowCard identifier="repos-per-language">
            <Image
              src={`http://github-profile-summary-cards.vercel.app/api/cards/repos-per-language?username=${userData.githubUser}&theme=midnight_purple`}
              width={1080}
              height={560}
          ...
          <GlowCard identifier="most-commit-language">
            <Image
              src={`http://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=${userData.githubUser}&theme=midnight_purple`}
              width={1080}
              height={560}
        ...
        <div className="md:col-span-2">
          <GlowCard identifier="top-langs">
            <Image
              src={`https://github-readme-stats.vercel.app/api/top-langs/?username=${userData.githubUser}&layout=compact&theme=neon&hide_border=true&&langs_count=8`}
              width={1080}
              height={560}
